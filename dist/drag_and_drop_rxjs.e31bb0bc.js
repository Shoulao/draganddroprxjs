...
var symbol = document.querySelector(".js");
var m_down$ = (0, _rxjs.fromEvent)(symbol, "mousedown");
var m_move$ = (0, _rxjs.fromEvent)(symbol, "mousemove");
var m_up$ = (0, _rxjs.fromEvent)(symbol, "mouseup");

var move = function move(start) {
  return m_move$.pipe((0, _operators.map)(function (move) {
    return {
      left: move.clientX - start.offsetX,
      top: move.clientY - start.offsetY
    };
  }), (0, _operators.takeUntil)(m_up$));
};

m_down$.pipe((0, _operators.switchMap)(move), (0, _operators.subscribeOn)(_rxjs.animationFrameScheduler)).subscribe(function (_ref) {
  var top = _ref.top,
      left = _ref.left;
  symbol.style.top = "".concat(top, "px");
  symbol.style.left = "".concat(left, "px");
});
...
//# sourceMappingURL=/drag_and_drop_rxjs.e31bb0bc.js.map